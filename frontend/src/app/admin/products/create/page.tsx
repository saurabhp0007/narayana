...
export default function CreateProductPage() {
  ...
  // Size + per-size stock inputs. Sizes are picked from a fixed vocabulary (predefined
  // clothing/shoe/dress sizes, plus anything already used in this category) — never
  // free-typed — and multiple sizes can be toggled at once to add them all with the
  // same stock value in one go.
