...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { href: '/admin/category-mapping', label: 'Category Mapping', icon: 'M7 7h3v3H7V7zm0 7h3v3H7v-3zm7-7h3v3h-3V7zm0 7h3v3h-3v-3z' },
